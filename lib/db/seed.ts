  ...
  await db.insert(coupleProfiles).values([
    {
      ...
      groomBaptismChurch: "Gereja Katedral Santo Yosef Martapura",
  ...
  db.insert(contents).values([
    {
      ...
      body: "Katedral Santo Yosef Martapura mengundang seluruh umat untuk mengikuti rangkaian perayaan Paskah 2026. Perayaan dimulai dengan Misa Kamis Putih pada tanggal 2 April 2026 pukul 18.00 WITA, dilanjutkan dengan Jalan Salib dan Liturgi Jumat Agung pada 3 April, serta puncak perayaan Vigili Paskah pada Sabtu 4 April pukul 19.00 WITA. Seluruh umat diharapkan hadir dan membawa keluarga masing-masing.",
      imageUrl: null,
      isPublished: true,
      createdBy: adminId,
    ...
    },
    {
      ...
      body: "Berikut jadwal lengkap Misa Natal dan Tahun Baru di Katedral Santo Yosef Martapura. Misa Malam Natal pada 24 Desember pukul 19.00 dan 22.00 WITA. Misa Hari Natal pada 25 Desember pukul 06.30, 08.00, dan 10.00 WITA. Umat dimohon hadir lebih awal untuk mendapatkan tempat duduk.",
      imageUrl: null,
      isPublished: true,
      createdBy: adminId,
    ...
    },
    {
      ...
      body: "Katedral Santo Yosef Martapura akan mengadakan kegiatan bakti sosial bertajuk 'Peduli Sesama' pada hari Sabtu, 10 Mei 2026. Kegiatan meliputi pembagian sembako, pemeriksaan kesehatan gratis, dan bazar murah. Umat yang ingin berpartisipasi sebagai relawan dapat mendaftarkan diri di sekretariat mulai 25 April 2026.",
      imageUrl: null,
      isPublished: true,
      createdBy: adminId,
